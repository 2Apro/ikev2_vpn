...
sudo apt install strongswan libcharon-extra-plugins libcharon-extauth-plugins libstrongswan-extra-plugins strongswan-plugin-eap-mschapv2 moreutils iptables-persistent
